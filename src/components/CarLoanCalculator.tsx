...
export function CarLoanCalculator() {
  ...
  const saveLoan = () => {
    ...
    const savedLoan = {
      ...
      name: `สินเชื่อรถยนต์ ${new Date().toLocaleDateString('th-TH')}`,
      type: 'รถยนต์',
  ...
  const downPaymentPercent = carPrice && downPayment 
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-indigo-100">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-indigo-900">ข้อมูลสินเชื่อรถยนต์</h2>
        </div>

        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="block text-gray-700">ราคารถ (บาท)</label>
            <input
              type="number"
              value={carPrice}
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-indigo-100">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                <p className="text-gray-600 mb-2">ราคารถ</p>
                <p className="text-blue-900">{result.carPrice.toLocaleString('th-TH')} บาท</p>
              </div>
